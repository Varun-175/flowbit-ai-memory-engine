...
export async function runInvoice2(invoice: Invoice) {
  console.log("\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
  console.log("📋 RUN: INV-A-003 (After Learning)");
  console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n");
  ...
  try {
    ...
    if (context.vendorMappings.length > 0) {
      console.log("    Mappings:");
      for (const vm of context.vendorMappings) {
        console.log(`      - "${vm.sourceKey}" → "${vm.targetField}" (confidence: ${vm.confidence.toFixed(2)}, reinforced ${vm.reinforcedCount}x)`);
      }
    }
